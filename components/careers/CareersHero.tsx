    ...
    <section className="relative py-15 pb-15 overflow-hidden bg-background">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
            ...
            >
                Architect Your <br />
                <span className="text-primary italic text-red-glow">Legacy</span> With Us.
            </motion.h1>
            ...
            >
                We are building industrial-grade digital ecosystems. We need elite engineers, visionary designers, and tactical leaders to define the future of technology.
            </motion.p>
        </div>
